...
class InvalidTreeTests(unittest.TestCase):
    ...
    def test_different_dimensions(self):
        ...
        points = [ (1, 2), (2, 3, 4) ]
        self.assertRaises(ValueError, kd_tree.create, points)


class TreeTraversals(unittest.TestCase):
    def test_same_length(self):
        tree = random_tree()
        inorder_len = len(list(tree.in_order()))
        preorder_len = len(list(tree.pre_order()))
        postorder_len = len(list(tree.post_order()))
